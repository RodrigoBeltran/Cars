...
const playerHud = {
  ...
  methods: {
    hudTick(data) {
      ...
      if (data.hunger >= 100) {
        this.hungerColor = "#7FFFD4";
      } else if(data.hunger <= 10){
      ...
      if (data.thirst >= 100) {
        this.thirstColor = "#7FFFD4";
      } else if(data.thirst <= 10){
