...
local config = Config
local speedMultiplier = config.UseMPH and 5.6 or 5.6
...
RegisterNetEvent("hud:client:LoadMap", function()
    ...
    elseif Menu.isToggleMapShapeChecked == "circle" then
        ...
        SetMinimapComponentPosition("minimap", "L", "B", -0.0005 + minimapOffset, -0.030, 0.180, 0.258)
        ...
        -- 0.252 = map stretched
        -- 0.338 = map shorten
        SetMinimapComponentPosition('minimap_blur', 'L', 'B', 0.015 + minimapOffset, 0.015, 0.252, 0.338)
        SetBlipAlpha(GetNorthRadarBlip(), 0)
        SetMinimapClipType(1)
        SetRadarBigmapEnabled(true, false)
        Wait(50)
